            ...
            editable ?
                editing ?
                    <div className="userpic-background fade-in">
                        <input
                            className="userpic-input userpic-text"
                            type="file"
                            accept="image/*"
                            onChange={(e) => {
