...
function UserOverview({pic, name, desc, rating, totalRatings}) {
                ...
                loading ?
                    (
                        ...
                        <div className="holder">
                            ...
                            <div className="overview-element fade-in">
                            ...
                            <button className="overview-button fade-in">
                                <label className="overview-text" >Thank you kindly!</label>
                            </button>
                        </div>
                    )
            }
