...
function UserPhone({ editable, phone }) {
    ...
    const updatePhone = async () => {
        ...
        try {
            const response = await Api.post(`authApi/user/updateUserPhoneNumber/${newPhone}`);
