      ...
      <main>
          <div className="holder">
              ...
              <div className="login-element fade-in">
                  ...
                  <input className="login-text" autoComplete="off" type="email" id="searchItem" placeholder="Email" />
              </div>
              <div className="login-element fade-in">
                  ...
                  <input className="login-text" autoComplete="off" type="password" id="searchItem" placeholder="Password" />
              </div>
