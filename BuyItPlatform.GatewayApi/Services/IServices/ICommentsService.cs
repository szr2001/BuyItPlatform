...
namespace BuyItPlatform.GatewayApi.Services.IServices
{
    ...
    {
        Task<MicroserviceResponseDto<Guid>> UploadCommentAsync(CommentUploadDto commentDto);
        ...
        Task<MicroserviceResponseDto<int>> CountListingCommentsAsync(string listingId);
